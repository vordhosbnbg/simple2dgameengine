...
{
    SDL_RenderCopyEx(renderer_handle.get(), drawable->GetTexture()->GetRawHandle(), drawable->GetSrcRect()->GetRawRect(), drawable->GetDstRect()->GetRawRect(), drawable->GetDrawableRotation(), NULL, SDL_FLIP_NONE);
}
